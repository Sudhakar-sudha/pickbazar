  ...
  return (
    ...
    >
      <div className="text-center px-4  md:-mt-20 mt-10">
        ...
        <div className="flex w-full max-w-xl shadow-lg rounded-2xl overflow-hidden mt-10 ml-20">
          <input
            type="text"
            value={query}
          ...
          <button
            ...
            className="bg-[#00b386] text-white px-6 py-3 hover:bg-green-600 flex items-center gap-2 cursor-pointer"
          >
            <FaSearch />
            Search
          </button>
